...
int main() {
  ...
  std::cout << "Starting CTE: " << cte << std::endl;
  // TODO: calculate the orientation error
  double epsi = psi - atan(coeffs[1]);  //since single order polynomial then psi_des is just the coefficient
  std::cout << "Starting epsi: " << epsi << std::endl;
